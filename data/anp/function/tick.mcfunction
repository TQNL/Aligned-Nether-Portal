...
scoreboard players enable @a toggle_vanilla_aligned_nether_portals_for_you
execute as @a[scores={toggle_vanilla_aligned_nether_portals_for_you=1..}] run function anp:vanilla_np
execute as @a[scores={toggle_vanilla_aligned_nether_portals_for_you=1..}] run function anp:vanilla_np_tell
execute as @a[scores={toggle_vanilla_aligned_nether_portals_for_you=1..}] run scoreboard players reset @s toggle_vanilla_aligned_nether_portals_for_you

# make a way back through for players stuck in a bad spawn
execute as @e[type=area_effect_cloud,tag=anp_player_pos,nbt={Age:298}] at @s run function anp:safe/safe2 with entity @s
